...
export const ProductCard = (product: Product) => {
  return (
    <div className="relative flex max-w-[300px] flex-col justify-between rounded-md border border-neutral-300 bg-white p-4 font-poppins shadow-sm h-[400px]"> {/* Establecer altura mínima aquí */}
      {product.discount && (
